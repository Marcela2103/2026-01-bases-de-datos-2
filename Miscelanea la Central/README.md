...
- Gestion de **clientes** con opción de crédito y abonos parciales
- Gestión de **proveedores** con opción de crédito y pagos parciales
- Registro de **combras**, **inventarios** y **ventas**
...
| `Unidad_4_Administración/`   | Backup, índices, optimización, concurrencia y auditoría |
